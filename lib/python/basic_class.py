...
class Loggger_debug_title():
    ...
    def title(self,infomessages='this is info message'):
        self.loggerr.info(infomessages)
...
if True:
    ...
    mylogger_title = Loggger_debug_title('WuKong')# example: asic_class.mylogger_title.info('step1')
