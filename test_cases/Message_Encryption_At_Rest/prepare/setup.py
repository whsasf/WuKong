...
create_passphrase_result = requests.post('http://{0}:{1}/mxos/encryption/v2/messageBodyEncryption'.format(mx1_mxos2host_ip,mx1_mxos2port), data = {'currentKey':'1001:aes-128-cbc:10011001'})
...
fetch_passphrase_result = requests.get('http://{0}:{1}/mxos/encryption/v2/messageBodyEncryption'.format(mx1_mxos2host_ip,mx1_mxos2port))
