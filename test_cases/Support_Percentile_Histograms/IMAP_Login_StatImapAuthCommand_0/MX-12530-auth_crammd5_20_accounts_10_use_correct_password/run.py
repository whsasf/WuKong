...
#step 1
basic_class.mylogger_record.info('step1:imap auth_crammd5:10 account with correct passwd, the other 10 use wrong pssswd')
...
result_lists = stat_statistics.stat_statistic(imapserv_stat_content,'[0]','StatImapAuthCommand',20)
